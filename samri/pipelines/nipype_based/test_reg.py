...
def structural_to_functional_per_participant_test():
	for i in ["","_aF","_cF1","_cF2","_pF"]:
		template = "/home/chymera/NIdata/templates/ds_QBI_chr.nii.gz"
		participant_no = "4001"
		func_image_dir = "/home/chymera/NIdata/ofM.dr/preprocessing/generic_work/_subject_condition_{}.ofM{}/_scan_type_7_EPI_CBV/temporal_mean/".format(participant_no,i)
		struct_image_dir = "/home/chymera/NIdata/ofM.dr/preprocessing/generic_work/_subject_condition_{}.ofM{}/_scan_type_T2_TurboRARE/structural_bru2nii/".format(participant_no,i)
		try:
			...
			warp.inputs.output_image = '{}_ofM{}.nii.gz'.format(participant_no,i)
			warp.num_threads = 4

			warp.inputs.input_image = func_image
			warp.inputs.transforms = registration_res.outputs.composite_transform
			warp.run()
