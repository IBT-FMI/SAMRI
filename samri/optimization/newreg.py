...
def structural(substitutions, parameters,
	reference='/usr/share/mouse-brain-templates/dsurqec_200micron.nii',
	...
	for substitution in substitutions:
		...
		if not os.path.isfile(image_path):
			...
			struct_registration.inputs.fixed_image_mask = '/usr/share/mouse-brain-templates/dsurqec_200micron_mask.nii'
