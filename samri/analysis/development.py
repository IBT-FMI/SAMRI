def dr_seed_fc():
	...
	fc_results = fc.seed_based(substitutions, "~/ni_data/templates/roi/DSURQEc_dr.nii.gz", '/usr/share/mouse-brain-templates/dsurqec_200micron_mask.nii',
...
def drp_seed_fc():
	...
	fc_results = fc.seed_based(substitutions, "~/ni_data/templates/roi/DSURQEc_drp.nii.gz", '/usr/share/mouse-brain-templates/dsurqec_200micron_mask.nii',
