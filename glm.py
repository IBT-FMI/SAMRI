...
def fsl_glm(workflow_base, functional_scan_type, anatomical_scan_type, workflow_denominator="FSL_GLM", omit_ID=[]):
	workflow_base = path.expanduser(workflow_base)
	bg_preproc_workflow = bg_preproc(workflow_base, functional_scan_type, anatomical_scan_type=anatomical_scan_type, omit_ID=omit_ID)
...
if __name__ == "__main__":
	quick_melodic(workflow_base="~/NIdata/ofM.dr/", functional_scan_type="7_EPI_CBV", anatomical_scan_type="4_T2_TurboRARE", omit_ID=["measurement_id_20151026_135856_4006_1_1"])
