...
def plot_stat_map(stat_map="/home/chymera/erc_level2/_scan_subtypes_EPI_CBV_alej/flameo/mapflow/_flameo0/stats/tstat1.nii.gz" ,template="/home/chymera/NIdata/templates/QBI_chr.nii.gz"):
	...
	plotting.plot_stat_map(stat_map, bg_img=template,threshold=3, title="plot_stat_map", black_bg=False, vmax=30, cmap=mymap)
	plt.show()
