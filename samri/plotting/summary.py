...
def plot_roi_per_session(df,
	...
	roi_width=0.3,
	roi_height=0.2,
	roi_anat='/usr/share/mouse-brain-templates/dsurqec_40micron_masked.nii',
	roi_threshold=None,
	cut_coords=None,
	samri_style=True,
	renames=[],
...
def responders(l2_dir,
	...
	roi_root='/usr/share/mouse-brain-templates',
	save_inplace=True,
	save_as='',
	):
...
def p_filtered_ts(substitutions,
	...
	event_file_template="~/ni_data/ofM.dr/preprocessing/{preprocessing_dir}/sub-{subject}/ses-{session}/func/sub-{subject}_ses-{session}_task-{scan}_events.tsv",
	p_level=0.1,
	brain_mask='/usr/share/mouse-brain-templates/dsurqec_200micron.niis'
	):
