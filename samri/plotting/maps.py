...
def _create_3Dplot(stat_maps,
	template_mesh='/usr/share/mouse-brain-templates/ambmc2dsurqec_15micron_masked.obj',
	threshold=3,
	positive_only=False,
	negative_only=False,
	vmin=None,
...
def atlas_label(atlas,
	alpha=1,
	overlay_alpha=1.0,
	anat='/usr/share/mouse-brain-templates/dsurqec_40micron_masked.nii',
	ax=None,
	color="#E69F00",
	fig=None,
	label_names=[],
...
def slices(heatmap_image,
	bg_image='/usr/share/mouse-brain-templates/dsurqec_40micron_masked.nii',
	contour_image='',
	heatmap_threshold=3,
	heatmap_alpha=1.0,
	contour_threshold=3,
