...
def pattern_activity():
	...
	subjectdf.to_csv('~/ni_data/ofM.dr/bids/l1/{}/pattern_summary.csv'.format(workflow_name))
...
def label_activity(label):
	...
	subjectdf.to_csv('~/ni_data/ofM.dr/bids/l1/{}/{}.csv'.format(workflow_name, label))
