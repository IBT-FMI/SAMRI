...
def responder_overview(workflow="subjectwise",cut_coords=None):
	...
	maps.stat(stat_maps, template="~/NIdata/templates/ds_QBI_chr.nii.gz", threshold=2.5, interpolation="gaussian", figure_title="Non/Responders", subplot_titles=subjects, cut_coords=cut_coords)
...
def session_overview(subset="all", cut_coords=None):
	...
	maps.stat(stat_maps, template="~/NIdata/templates/ds_QBI_chr.nii.gz", threshold=2.5, interpolation="gaussian", figure_title="Sessions", subplot_titles=sessions, cut_coords=cut_coords)
...
if __name__ == '__main__':
	...
	session_overview("sessionwise_dr_mask")
