...
import sys
sys.path.append("/home/chymera/src/nipy/examples/labs/need_data/")
...
from nipy.modalities.fmri.experimental_paradigm import load_paradigm_from_csv_file, BlockParadigm, EventRelatedParadigm
...
paradigm1 = load_paradigm_from_csv_file(paradigm_file)['0']
onsets = []
base = [9,19,29,39,49]
delay = 0.5
for i in range(5):
	onsets.extend([onset+delay+25*i for onset in base])
conditions = ["laser"]*25
print(onsets)
paradigm = EventRelatedParadigm(con_id=conditions ,onset=onsets)
